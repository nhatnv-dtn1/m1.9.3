...
jQuery(document).ready(function($) {
	...
	$closeSearch.click(function() {
		$(this).closest('.search-switcher').removeClass('toggle-visible').find('.toggle-content').removeClass('visible');
	});
	...
	// animate number
	$(function() {
		var report = $('.cms-static-report-team.report-team'); //get the offset top of the element
		if(report.length){
			var eTop = report.offset().top -400;
