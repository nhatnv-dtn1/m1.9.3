	...
	function _qsJnit(){
		...
		qsHandlerImg.fancybox({
				...
				beforeShow : function(){
			        ...
			        if(Themecfg.detail.slide > 0) quickview.find(".product-image-thumbs").bxSlider({infiniteLoop: true , minSlides: 3, visibleItems: 3, maxSlides: 2, slideMargin: 18, slideWidth: Themecfg.detail.slideWidth, mode: modeSlide, controls: parseInt(Themecfg.detail.controls), pager: parseInt(Themecfg.detail.pager), responsiveBreakpoints : {480: 1, 640: 2, 768: 3, 900: 3}});
